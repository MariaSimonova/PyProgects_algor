...
print(timeit.timeit("bubble_sort(orig_list_2[:])", setup="from __main__ import bubble_sort, orig_list_2", number=1000))
...
print(timeit.timeit("bubble_sort(orig_list_3[:])", setup="from __main__ import bubble_sort, orig_list_3", number=1000))

"""
замеры 10  = 0.004932199999999998
замеры 100 = 0.0349964
замеры 1000 = 0.626341
"""
